...
if(isset($_POST['backup']))
{
	...
	//	$link = mysql_connect($host,$user,$pass);
		...
		//save file
		$handle = fopen('F:\My Reference_IOT\SKG\SKG Data Backup/db-backup-'.date('d-m-Y-h-i-s').'.sql','w+'); 	// change as per system
		fwrite($handle,$return1);
		fclose($handle);
	}

	$strdescription .= "Backup Created in the folder F:\My Reference_IOT\SKG\SKG Data Backup";
}
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <form role="form" method="post" action="backup1.php">
                        <fieldset>
							 <input type="button" value="Click To Create Backup" name="backup" id="backup">
                        </fieldset>
                    </form>
