...
<head>
    ...
    <script>
		...
		function selectdate(){
			...
			url         = "http://localhost/SKG/admins/payslip/index.php?bcid=" + bcid + "&memid=" + memid + "&spdate=" + spdate;
		...
		function exportdata()
		{
			...
			var memid = document.getElementById("selectmem").value;
			var spdate = document.getElementById("spdate").value;
			url         = "http://localhost/SKG/admins/payslip/export.php?bcid=" + bcid + "&memid=" + memid + "&spdate=" + spdate;
			document.location=url;
		}
		function printdata()
		{
			...
			window.print();
			url         = "http://localhost/SKG/admins/payslip/index.php";
			document.location=url;
		}
		function filter() {
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-users fa-fw"></i> Generate Payment Slip By BC Wise / Member Wise / BC and Member Wise / On Specific Date </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <form role="form" method="post" action="index.php">
                        <fieldset>
							...
							<div class="form-group">
								<table width="800" border="0" align="center">
								<tr>
								<th><label>Select Specific Date for which you want to generate Payment Slip</label></th>
							...
							//		echo "$query";
								...
								<?php	
									...
									//	echo "spdate=" . $spdate;
										...
										$result3 = $mysqli->query("SELECT bcmembers from bc_details where flag='open' and bcid='".$id."'");
