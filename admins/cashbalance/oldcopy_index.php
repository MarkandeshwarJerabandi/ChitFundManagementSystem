...
<head>
    ...
    <script>
		...
		function selectdate(){
			...
			url         = "http://localhost/SKG/admins/Reports/index.php?bcid=" + bcid + "&memid=" + memid + "&bcdate=" + bcdate + "&spdate=" + spdate + "&collection=" + c;
		...
		function exportdata()
		{
			...
			var spdate = document.getElementById("spdate").value;
			var c = document.getElementById("collection").value;
			url         = "http://localhost/SKG/admins/Reports/export.php?bcid=" + bcid + "&memid=" + memid + "&bcdate=" + bcdate + "&spdate=" + spdate + "&collection=" + c;
			document.location=url;
		}
		function dispothers()
		{
			...
			{
				url         = "http://localhost/SKG/admins/Reports/index.php?bcid=" + bcid + "&memid=" + memid + "&bcdate=" + bcdate + "&spdate=" + spdate + "&collection=" + '';
				document.location=url;
			}
		}
		function printdata()
		{
			...
			window.print();
			url         = "http://localhost/SKG/admins/Reports/index.php";
			document.location=url;
		}
		function filter() {
                    ...
                    <form role="form" method="post" action="index.php">
                        <fieldset>
							...
							<div class="form-group">
								...
								<tr>
								<th colspan="2"><label>Select Date of BC</label></th>
								...
								<tr>
								<th colspan="2"><label>Select Specific Date for which you want to see payment details</label></th>
